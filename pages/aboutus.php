...
<header>
  ...
  <div class="container-fluid">
    <div class="row">
        <div class="col-lg-7 col-12">
          <h3 class="crimsonbg whiteText text-center" style="padding-bottom:0.25%;">Our project</h3>
          <br>
          <div class="col-push-12 d-lg-block"
 ...
 <p class="italicText">Disclaimer: We do not organise real fights and do not encourage such activity in our school.</p>
        ...
        <div class="col-lg-5 col-12-pull">
            <img src="..\images\30anniversary.jpg" alt="UKTC" height="300" title="The Vocational School of Computer Technology in the city of Pravets">
        </div>
    </div>
...
<div class="row" style="padding-top:5%;padding-bottom:2%">
        ...
        <div class="col-lg-4 col-6">
            <img src="..\images\Screenshot_54.png" alt="BKS bate" height="300" title="Ph">
        </div>
    </div>
</div>
    <footer>
